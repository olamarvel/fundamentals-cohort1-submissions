...
const AdminDashboard = () => {
  ...
  const recentUsers = [
    ...
    { id: 3, firstName: 'Bob', lastName: 'Johnson', email: 'bob@example.com', status: 'suspended' }
  ];
      ...
      <div className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Monitor and manage FlowServe platform</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">Active VCCs</p>
                  <p className="text-2xl font-semibold text-gray-900">{stats.activeVCCs}</p>
                </div>
              </div>
            </div>
          </div>
